...
namespace MarketingDataSystem.API.Migrations
{
    ...
    [Migration("20250619184602_SeedData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarketingDataSystem.Core.Entities.UsuarioMarketing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2025, 6, 19, 15, 46, 1, 893, DateTimeKind.Local).AddTicks(5446),
                            Nombre = "Administrador",
                            PasswordHash = "$2a$11$nf0Y8ETwacI6i1tmln3veeZoD8NEA0s/UC9Qc4XUDHlx7fxK4p52i",
                            Role = "Admin",
                            Username = "admin"
                        });
                });
            ...
            modelBuilder.Entity("MarketingDataSystem.Core.Entities.Stock", b =>
                {
                    b.HasOne("MarketingDataSystem.Core.Entities.Producto", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MarketingDataSystem.Core.Entities.Venta", b =>
                {
                    ...
                    b.HasOne("MarketingDataSystem.Core.Entities.Cliente", null)
                        .WithMany()

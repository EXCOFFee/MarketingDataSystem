...
{
    /// <summary>
    /// Repositorio concreto para FuenteDeDatos.
    /// Cumple con el principio de sustitución de Liskov (L de SOLID) y el patrón Repository.
    /// </summary>
    public class FuenteDeDatosRepository : GenericRepository<FuenteDeDatos>, IFuenteDeDatosRepository
    {
        public FuenteDeDatosRepository(MarketingDataContext context) : base(context) { }
    }
} 
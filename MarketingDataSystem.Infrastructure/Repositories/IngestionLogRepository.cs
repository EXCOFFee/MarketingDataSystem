...
{
    /// <summary>
    /// Repositorio concreto para IngestionLog.
    /// Cumple con el principio de sustitución de Liskov (L de SOLID) y el patrón Repository.
    /// </summary>
    public class IngestionLogRepository : GenericRepository<IngestionLog>, IIngestionLogRepository
    {
        public IngestionLogRepository(MarketingDataContext context) : base(context) { }
    }
} 